...
mod tests {
    ...
    #[test]
    fn permissions_request_approval_accepts_profile_persistence_metadata() {
        let params = serde_json::from_value::<PermissionsRequestApprovalParams>(json!({
            "threadId": "thr_123",
            "turnId": "turn_123",
            "itemId": "call_123",
        ...
        assert_eq!(
            params.permissions_profile_persistence,
    ...
    #[test]
    fn permissions_request_approval_response_accepts_persist_scope() {
        let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(json!({
            "permissions": {},
            "scope": {
                "type": "persist",
                "permissionProfileAmendment": {
                    ...
                    "permissions": {
                        "fileSystem": {
                            "write": [if cfg!(windows) { r"C:\\tmp\\out.txt" } else { "/tmp/out.txt" }],
                        },
                    },
                },
            },
                ...
                permission_profile_amendment: PermissionProfileAmendment {
                    ...
                    permissions: AdditionalPermissionProfile {
                        ...
                        file_system: Some(AdditionalFileSystemPermissions {
                            read: None,
                            write: Some(vec![
                                AbsolutePathBuf::try_from(PathBuf::from(expected_path))
                                    .expect("path must be absolute"),
                            ]),
                        }),
                    },
